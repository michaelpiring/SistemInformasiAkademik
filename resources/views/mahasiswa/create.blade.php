    ...
    <form action="{{ route('mahasiswa.store') }}" method="POST" >
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Nama:</strong>
                    <input type="text" class="form-control" style="height:50px" name="nama_mahasiswa"
                        placeholder="Nama">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="jalur_masuk" class="form-control" placeholder="Jalur Masuk">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>ID Prodi:</strong>
                    <input type="number" name="id_prodi" class="form-control" placeholder="ID Prodi">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>ID UKT:</strong>
                    <input type="number" name="id_ukt" class="form-control" placeholder="ID UKT">
                </div>
            </div>
